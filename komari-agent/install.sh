...
if [ -n "$github_proxy" ]; then
    ...
    download_url="${github_proxy}/https://github.com/ctfox66/my-tz-kori/releases/${download_path}/${file_name}"
else
    # Direct access to GitHub releases
    download_url="https://github.com/ctfox66/my-tz-kori/releases/${download_path}/${file_name}"
fi
