...
if ($InstallVersion -ne "") {
    ...
    $ApiUrl = "https://api.github.com/repos/ctfox66/my-tz-kori/releases/latest"
    try {
...
$BinaryName = "komari-agent-windows-$arch.exe"
$DownloadUrl = if ($GitHubProxy) { "$GitHubProxy/https://github.com/ctfox66/my-tz-kori/releases/download/$versionToInstall/$BinaryName" } else { "https://github.com/ctfox66/my-tz-kori/releases/download/$versionToInstall/$BinaryName" }
